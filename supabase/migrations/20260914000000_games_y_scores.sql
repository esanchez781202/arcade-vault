...
-- Crea las tablas `games` y `scores`, sus policies de RLS, y siembra `games`
-- con los 9 juegos que hoy viven en lib/games.ts (incluido 'asteroids' de SPEC 05).
...
-- ===== Siembra de games (copiada literalmente de lib/games.ts) =====
