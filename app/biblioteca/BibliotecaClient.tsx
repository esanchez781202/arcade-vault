...
// Parte interactiva de /biblioteca (buscador, filtro por categoría, tarjetas).
// Extraída de page.tsx para que la carga de datos (obtenerJuegos) pueda vivir
// en un Server Component; ver app/biblioteca/page.tsx.
...
export default function BibliotecaClient({
  ...
  const select = (game: Game) => router.push(`/juego/${game.id}`);
