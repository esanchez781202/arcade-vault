...
// Parte interactiva de la Home (landing). Portado de references/templates/home-about/home.jsx.
// El router por hash (navigate({name,id})) se sustituye por useRouter() de next/navigation.
// Extraída de page.tsx para que la carga del catálogo (obtenerJuegos) viva en un Server Component.
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            ...
            <button className="btn xl magenta" onClick={() => router.push("/acceso")}>
              ✦ CREAR CUENTA
            </button>
          </div>
